...
function Footer() {
  return (
    ...
    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Total Solution</span>
    </a>
    </div>
    ...
    <li className="mb-4">
    <Link to='/' className="hover:underline">React</Link>
    </li>
    <li>
    ...
    <ul className="text-gray-600 dark:text-gray-400">
    <li className="mb-4">
    <a href="https://github.com/SUMIT746689" className="hover:underline ">Github</a>
    </li>
    </ul>
    </div>
    <div>
